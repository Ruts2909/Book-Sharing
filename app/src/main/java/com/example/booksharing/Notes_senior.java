...
public class Notes_senior extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabadeRef= FirebaseDatabase.getInstance().getReference().child("Notes");
...
//        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==PICK_IMAGE_REQUEST && resultCode==RESULT_OK && data!=null && data.getData()!=null){
            ...
            mFilename = mStorageRef.child("notes" + mImageUri.getLastPathSegment());
        }
        {
    ...
    private  void uploadFile() {
        if (mImageUri != null) {
            ...
            mFilename.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Notes_senior.this, e.getMessage(), Toast.LENGTH_LONG).show();
                }
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    double progress = (100.0 * taskSnapshot.getBytesTransferred() / taskSnapshot.getTotalByteCount());
                    mProgressBar.setProgress((int) progress);
                    Toast.makeText(Notes_senior.this, "File Uploaded", Toast.LENGTH_LONG).show();
                }
            });
        }
        else
